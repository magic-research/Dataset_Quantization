...
parser.add_argument('train_data_dir', metavar='DIR',
                    help='train dataset root')
parser.add_argument('eval_data_dir', metavar='DIR',
                    help='eval dataset root')
...
group.add_argument('--output', default='../output/timm_output', type=str, metavar='PATH',
...
def main():
    ...
    dataset_train = create_dataset(
        args.dataset, root=args.train_data_dir, split=args.train_split, is_training=True,
        class_map=args.class_map,
        download=args.dataset_download,
        batch_size=args.batch_size,
        repeats=args.epoch_repeats)
    dataset_eval = create_dataset(
        args.dataset, root=args.eval_data_dir, split=args.val_split, is_training=False,
        class_map=args.class_map,
        download=args.dataset_download,
        batch_size=args.batch_size)
